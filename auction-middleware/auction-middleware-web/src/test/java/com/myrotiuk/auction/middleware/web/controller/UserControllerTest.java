...
public class UserControllerTest {
    ...
    public void testPostUserToUserControllerShouldReturnValidJson() throws Exception {
        ...
        when(userService.create(userArgumentCaptor.capture())).thenReturn(expected);
        ...
        assertEquals(req.getName(),userArgumentCaptor.getValue().getName());
        assertEquals(req.getUsername(),userArgumentCaptor.getValue().getUsername());
        assertEquals(req.getPassword(),userArgumentCaptor.getValue().getPassword());
